...
class TextClassProcessor(DataProcessor):
    """Processor for this project (Abstract classification). Only adjust this Processor"""
...
class XnliProcessor(DataProcessor):
  """Processor for the XNLI data set, not used in this project."""
...
class MnliProcessor(DataProcessor):
  """Processor for the MultiNLI data set (GLUE version). Not used in this project"""
...
class MrpcProcessor(DataProcessor):
  """Processor for the MRPC data set (GLUE version). Not used in this project"""
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  A single layer of fully connected layer for classification
  """
  ...
  # segment.
  # model_pooled_output() returns a pooled representation by simply taking the hidden state corresponding to the first
  # token. Thre returned tensor has fixed size [batch_size, hidden_size].

  # If you want to use the token-level output, use model.get_sequence_output(), which returns hidden state corresponding
  # to each token. The return length is not fixed in this case with return tensor [batch_size, seq_length, hidden_size]
  # The return lenght could be fixed if padding is used
  #
